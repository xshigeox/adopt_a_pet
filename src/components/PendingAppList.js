    ...
    <div className="add-pets-section">
      ...
      <div className="small-6 columns add-friend div-pending-button">
        <div className="add-friend-action">
          <button className="button primary small"><i className="far fa-smile" aria-hidden="true"></i> Approve</button>
          <button className="button secondary small"><i className="far fa-frown" aria-hidden="true"></i> Deny</button>
        </div>
      </div>
      </div>
    </div>
